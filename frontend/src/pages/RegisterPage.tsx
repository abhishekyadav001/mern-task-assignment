      ...
      <Fade in timeout={800}>
        ...
        >
          ...
          <Stack spacing={3}>
            ...
            <Stack spacing={2.5}>
              <Slide direction="left" in timeout={1200} mountOnEnter unmountOnExit>
                <TextField
                  label="Full Name"
                  value={name}
              ...
              <Slide direction="left" in timeout={1400} mountOnEnter unmountOnExit>
                <TextField
                  label="Email Address"
                  type="email"
                  value={email}
              ...
              <Slide direction="left" in timeout={1600} mountOnEnter unmountOnExit>
                <TextField
                  label="Password"
            ...
            <Slide direction="up" in timeout={2000} mountOnEnter unmountOnExit>
              <Box textAlign="center">
